...
function insertmessage($msg, $adminid, $userid){
     global $connect;
     $statment = $connect->prepare("INSERT INTO `messsage`(`message_text`, `message_adminid`, `message_userid`) VALUES (?,?,?)");
     $statment->execute(array($msg,$adminid,$userid));
